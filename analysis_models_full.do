...
*** Open log file
	log using 			"${logfiles}/03_analysis_models_full.log", replace
...
* ---------------------------------------------------------------------------- *
	...
	*Retrieving Predicted Probabilities
	...
	putexcel set "${tables}/margins/margins_risk_full", sheet("RISK") replace
	putexcel A1 = matrix(risk), names
	
	// Saving model estimates
	esttab using "${tables}/models/risk_logit_full.csv", ///
		replace se r2 ar2 nobaselevels 
	est clear
	
	// --> Figure 3: Predicted temporary employment probabilities by education
...
* ---------------------------------------------------------------------------- *
	...
	*
	...
	// Saving model estimates
	esttab using "${tables}/models/vuln_feis_full.csv", ///
		replace se r2 ar2 nobaselevels 
...
* ---------------------------------------------------------------------------- *
	...
	*
	...
	esttab base_feis_1 base_feis_2 base_feis_3 ///
		...
		using "${tables}/models/gc_feis_full.csv", ///
	...
	****************************************************************************
	...
	putexcel set "${tables}/decomposition/decomposition_`type'_full", sheet("decomposition") replace
...
*
	...
	**********************
	...
	// Load data
	import excel "H:\Christoph\art2\04_tables\decomposition\decomposition_temp_full.xlsx", ///
	...
	* Save estimates
	save "${tables}/decomposition/decomposition_temp_full.dta", replace
	
	export excel using "H:\Christoph\art2\04_tables\decomposition\decomposition_temp_full.xlsx", ///
	...
	********************
	...
	// Load data
	import excel "H:\Christoph\art2\04_tables\decomposition\decomposition_cum_full.xlsx", ///
		sheet("decomposition") firstrow clear
	...
	* Save estimates
	save "${tables}/decomposition/decomposition_cum_full.dta", replace
	
	export excel using "H:\Christoph\art2\04_tables\decomposition\decomposition_cum_full.xlsx", ///
		sheet("final") firstrow(variables)
